      ...
      <SignUp.Root>
        ...
        >
          <header className="text-center">
            <h1 className="mt-3 text-base font-bold tracking-wide text-yellow-400 uppercase font-game">Verify Email Code</h1>
          </header>

          <Clerk.GlobalError className="block text-sm text-red-500" />
          <SignUp.Strategy name="email_code">
            <Clerk.Field name="code" className="space-y-1">
              <Clerk.Label className="font-bold text-yellow-400 uppercase font-game">Email Code</Clerk.Label>
        ...
        >
          <header className="text-center">
            <h1 className="mt-3 text-base font-bold tracking-wide text-yellow-400 uppercase font-game">Continue Registration</h1>
          </header>

          <Clerk.GlobalError className="block text-sm text-red-500" />
          <Clerk.Field name="username" className="space-y-1">
            <Clerk.Label className="font-bold text-yellow-400 uppercase font-game">Username</Clerk.Label>
